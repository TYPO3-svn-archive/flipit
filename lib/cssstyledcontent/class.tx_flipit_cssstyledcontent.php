 ...
 *
 *
 *   68: class tx_flipit_cssstyledcontent extends tslib_pibase
 *
...
class tx_flipit_cssstyledcontent extends tslib_pibase {
	...
	var $prefixId = 'tx_flipit_cssstyledcontent';		// Same as class name
	var $scriptRelPath = 'lib/class.tx_flipit_cssstyledcontent.php';	// Path to this script relative to the extension dir.
	var $extKey = 'flipit';		// The extension key.
	var $conf = array();
...
if (defined('TYPO3_MODE') && isset($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/flipit/lib/cssstyledcontent/class.tx_flipit_cssstyledcontent.php'])) {
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/flipit/lib/cssstyledcontent/class.tx_flipit_cssstyledcontent.php']);
}
